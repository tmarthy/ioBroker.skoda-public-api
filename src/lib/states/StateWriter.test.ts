...
/**
 * Adapter-Doppel. Es bildet die eine Eigenschaft nach, auf die es hier ankommt:
 * `setStateChangedAsync` schreibt nur bei einer Aenderung. Sonst liesse sich
 * "ein zweiter Durchlauf schreibt keinen einzigen State" gar nicht pruefen.
 */
class FakeAdapter implements StateApi {
